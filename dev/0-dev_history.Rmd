...
fusen::fill_description(
  pkg = here::here(),
  fields = list(
    Title = "Analysis of GBV Results",
    Description = "This package analysis the GBV data for expenditure and results.",
    `Authors@R` = c(
      person("Herzel", "Mukandi", email = "mukandiherzel@gmmail.com", role = c("aut", "cre"), comment = c(ORCID = "0000-0000-0000-0000"))
    )
  )
)
# Define License with use_*_license()
usethis::use_mit_license("Herzel Mukandi")
```
...
# Code of Conduct
usethis::use_code_of_conduct("N/A")
# NEWS
usethis::use_news_md()
```
